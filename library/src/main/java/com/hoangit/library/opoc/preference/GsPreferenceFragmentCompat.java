 ...
 */
package com.hoangit.library.opoc.preference;
...
import com.hoangit.library.opoc.util.Callback;
import com.hoangit.library.opoc.util.ContextUtils;
...
public abstract class GsPreferenceFragmentCompat<AS extends SharedPreferencesPropertyBackend> extends PreferenceFragment
        implements SharedPreferences.OnSharedPreferenceChangeListener, PreferenceFragment.OnPreferenceStartFragmentCallback {
    ...
    protected void onPreferenceScreenChanged(PreferenceFragment preferenceFragmentCompat, PreferenceScreen preferenceScreen) {
    }
